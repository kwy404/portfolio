...
function AirplaneIcon({className} : {
    ...
    return (<svg className={className}
        ...
        <path d="M2.5 19.5 21 12 2.5 4.5 2.5 10 17 12 2.5 14z"/>
    </svg>);
}
...
const tracks: Track[] = [
    {
        albumImage: "https://images-na.ssl-images-amazon.com/images/I/91sLchfSmpL._SL1500_.jpg",
    ...
    },
    {
        ...
        albumImage: "https://img.discogs.com/4LpUtQvsNYUFTZElCylqHkafqCA=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-1979737-1379562813-9692.jpeg.jpg",
        ...
        albumImage: "https://static.fnac-static.com/multimedia/Images/PT/NR/2b/51/05/348459/1540-6/tsp20160817182810/Acoustica.jpg",
        title: "Alien Nation",
        album: "Scorpions",
        artist: "Scorpions",
...
export default function ControlCenter() {
    ...
    useEffect(() => {
        if (overlayRef.current) {
            ...
            // Aplica opacidade no body (0 = totalmente transparente, 1 = opaco)
            document
                .body
                .style
                .opacity = `${
            ...
            // overlay recebe pointer events só se estiver aberto
            overlayRef
                .current
                .style
                .pointerEvents = open
    ...
    return (<> {/* Overlay for brightness control, always rendered */}
        <div ref={overlayRef}
            style={
                {
                    position: 'fixed',
        ...
        <div className="fixed top-0 left-0 w-full flex justify-center z-[9999999999]"
            style={
                {
                    pointerEvents: open
                        ? "none"
            ...
            <div className="w-14 h-2 rounded-full bg-black/20 mt-2 mb-2"
                style={
                    {
                        opacity: 0.7,
                        cursor: "pointer",
        ...
        <motion.div initial={false}
            ...
            onTouchStart={handleTouchStart}
            onTouchMove={handleTouchMove}
            onTouchEnd={handleTouchEnd}> {/* Close handle (for drag up to close) */}
            <div className="w-16 h-2 rounded-full bg-black/20 mx-auto mt-2 mb-4"
                style={
                    {
                        opacity: 0.7
                    }
                }/>
            <div className="flex-1 flex flex-col gap-6 px-3 md:px-5 pb-6 overflow-y-auto"
                style={
                    {
                        maxHeight: '88vh'
                    }
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="grid grid-cols-4 gap-4 mx-auto w-full max-w-[380px]">
                        <IconButtonIOS Icon={AirplaneIcon}
                            active={airplaneMode}
                            onClick={
                                () => {
                                    setAirplaneMode(v => !v);
                        ...
                        <IconButtonIOS Icon={Wifi}
                            active={wifi}
                            onClick={
                                () => !airplaneMode && setWifi(v => !v)
                            }
                            ariaLabel="Wi-Fi"/>
                        <IconButtonIOS Icon={Bluetooth}
                            active={bluetooth}
                            onClick={
                                () => !airplaneMode && setBluetooth(v => !v)
                            }
                            ariaLabel="Bluetooth"/>
                        <IconButtonIOS Icon={Battery}
                            active={batteryCharging}
                            onClick={
                                () => setBatteryCharging(v => !v)
                            }
                            ariaLabel="Bateria"/>
                    </div>
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    <div className="grid grid-cols-4 gap-4 mx-auto w-full max-w-[380px]">
                        <IconButtonIOS Icon={Airplay}
                            ariaLabel="Airplay"/>
                        <IconButtonIOS Icon={Phone}
                            ariaLabel="Vivo">
                            <span className="text-xs">Vivo</span>
                        </IconButtonIOS>
                        <IconButtonIOS Icon={Flashlight}
                            ariaLabel="Lanterna"/>
                        <IconButtonIOS Icon={Timer}
                            ariaLabel="Timer"/>
                    </div>
                </div>
                <div className="flex flex-row gap-4 w-full max-w-[380px] mx-auto">
                    <div className="flex-1 flex flex-col items-center justify-center bg-white/95 rounded-2xl border border-black/10 p-3 shadow">
                        ...
                        <input type="range"
                            ...
                            value={brightness}
                            onChange={
                                e => setBrightness(Number(e.target.value))
                            }
                            aria-label="Brilho"
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center bg-white/95 rounded-2xl border border-black/10 p-3 shadow">
                        ...
                        <input type="range"
                            ...
                            value={volume}
                            onChange={
                                e => setVolume(Number(e.target.value))
                            }
                            aria-label="Volume"
                ...
                <div className="w-full max-w-[380px] mx-auto rounded-2xl p-4 flex flex-col items-center bg-white/95 border border-black/10 shadow">
                    ...
                    <img src={
                            tracks[trackIndex].albumImage
                        }
                        alt={
                            tracks[trackIndex].album
                        }
                    ...
                    <div className="flex items-center gap-2 w-full mt-1">
                        <span className="text-black/60 text-xs w-8 text-right"> {
                        ...
                        <input type="range"
                            ...
                            value={audioTime}
                            onChange={
                                e => setTrackTime(Number(e.target.value))
                            }
                            className="flex-1 accent-pink-400"
                            aria-label="Progresso da música"/>
                        <span className="text-black/60 text-xs w-8 text-left"> {
                            formatTime(audioDuration)
                        }</span>
                    </div>
                    <div className="flex items-center gap-2 mt-2 w-full justify-center">
                        <button className="text-black/80 hover:text-black w-8 h-8 flex items-center justify-center rounded-full" aria-label="Anterior"
                            onClick={playPrev}
                            disabled={audioLoading}>
                            &#9664;&#9664;
                        </button>
                        <button className="text-black/80 hover:text-black w-8 h-8 flex items-center justify-center rounded-full relative"
                            aria-label={
                                playing
                                    ? "Pause"
                                    : "Play"
                        ...
                        <button className="text-black/80 hover:text-black w-8 h-8 flex items-center justify-center rounded-full" aria-label="Próxima"
                            onClick={playNext}
                            disabled={audioLoading}>
                            &#9654;&#9654;
                        </button>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <div className="grid grid-cols-4 gap-4 mx-auto w-full max-w-[380px]">
                        <IconButtonIOS Icon={Headphones}
                            ariaLabel="Fones"/>
                        <IconButtonIOS Icon={Contrast}
                            ariaLabel="Contraste"/>
                        <div/>
                        <div/>
                    </div>
